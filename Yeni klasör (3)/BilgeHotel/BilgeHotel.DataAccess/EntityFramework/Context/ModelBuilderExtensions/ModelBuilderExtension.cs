...
namespace BilgeHotel.DataAccess.EntityFramework.Context.ModelBuilderExtensions
{
    public static class ModelBuilderExtension
    {
        ...
        public static void Seed(this ModelBuilder builder)
        {
            ...
            //    new Role { Id = 1, Name = "SatisDepartmaniYoneticisi" },
            //    new Role { Id = 2, Name = "InsanKaynaklariYoneticisi" },
            //    new Role { Id = 3, Name = "ITSorumlusu" },
            //    new Role { Id = 4, Name = "ResepsiyonSefi" }
            //    );
            //#endregion
            ...
            builder.Entity<Employee>().HasData(
               new Employee {Id=1, Adress = "Sırasöğütler", UserName = "osmana", FirstName = "Osman", PhoneNumberConfirmed = true, EmailConfirmed = true, TwoFactorEnabled = false, LockoutEnabled = false, LastName = "Şahin", Phone = "12345678955", Salary = 500, Email = "1serkana60@gmail.com" },
               new Employee {Id=2, Adress = "Sırasöğütler", UserName = "murata", FirstName = "Murat", LastName = "Şahin", Phone = "12345678955", Salary = 100, Email = "1osmana60@gmail.com" },
               new Employee {Id =3,  Adress = "Sırasöğütler", UserName = "mehmete", FirstName = "Mehmet", LastName = "Şahin", Phone = "12345678955", Salary = 200, Email = "1mustafa60@gmail.com" },
               new Employee {Id=4, Adress = "Sırasöğütler", UserName = "gayee", FirstName = "Gaye", LastName = "Şahin", Phone = "12345678955", Salary = 200, Email = "1mehmet@gmail.com" }
                 );
            #endregion
